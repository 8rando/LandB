  ...
  return (
    <div className="min-h-screen md:h-screen md:overflow-hidden bg-gray-50 flex flex-col md:flex-row">
      ...
      <header className="md:hidden sticky top-0 z-30 flex items-center justify-between bg-white border-b border-gray-200 px-3 h-14 shadow-sm">
        ...
        <button
          onClick={toggleTheme}
          className="w-8 h-8 flex-shrink-0 rounded-full bg-yellow-100 flex items-center justify-center"
        ...
        <div className="md:hidden fixed inset-0 z-40">
          ...
          <div className="absolute left-0 top-0 h-full w-72 max-w-[85%] bg-white shadow-2xl flex flex-col">
            ...
            <div className="border-t border-gray-200 p-3 flex-shrink-0 space-y-1">
              <button
                onClick={toggleTheme}
                className="flex items-center w-full gap-2.5 rounded-lg py-2.5 px-3 text-gray-500 hover:text-gray-900 hover:bg-gray-100 transition-colors"
              >
      ...
      <aside
        ...
        className="hidden md:flex md:flex-col md:h-screen relative z-20 flex-shrink-0 bg-white border-r border-gray-200 shadow-sm"
      >
        {/* ── Logo ── */}
        <div className="h-[72px] flex items-center border-b border-gray-200 px-3 overflow-hidden flex-shrink-0">
          <img
            src={lbLogo}
            alt="L & B Limited"
        ...
        {/* ── Theme toggle + User / Logout (pinned) ── */}
        <div className="border-t border-gray-200 p-3 overflow-hidden flex-shrink-0">
          {/* Theme toggle */}
          <div className="relative group/theme mb-2">
            <button
              onClick={toggleTheme}
              className={`flex items-center w-full rounded-lg py-2 text-gray-500 hover:text-gray-900 hover:bg-gray-100 transition-colors ${
